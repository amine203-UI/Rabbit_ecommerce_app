...
const Register = () => {
  ...
  return (
    <div className='flex'>
      <div className='w-full md:w-1/2 flex flex-col justify-center items-center p-88 md:p-12'>
       <form onSubmit={handleSubmit} className='w-full max-w-md bg-white p-12 rounded-sm  '>
          ...
          <button type='submit' className='w-full bg-black text-white p-2 rounded-sm font-semibold hover:bg-gray-500 transition'>{loading ? "Loading..." : "Sign In "}</button>
      ...
      <div className='hidden md:block w-1/2 bg-gray-500'>
         <div className='h-full flex flex-col justify-center items-center'>
                <img src={register} alt="Login to Account" className='h-[690px] w-full object-cover' />
