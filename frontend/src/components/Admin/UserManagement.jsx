    ...
    <div className="max-w-7xl max-auto p-6">
      ...
      <div className="p-6 rounded-sm mb-6">
         ...
         <form onSubmit={handleSubmit}>
                ...
                <button type="submit" className="bg-green-500 text-white py-2 px-4 rounded hover:bg-green-500">Add User</button>
         </form>

          {/* User list Management */}
          <div className="overflow-x-auto shadow-md sm:rounded-lg mt-8">
              <table className="min-w-full text-left text-gray-500">
                  <thead className="bg-gray-100 text-xs uppercase text-gray-2000">
                      <tr>
